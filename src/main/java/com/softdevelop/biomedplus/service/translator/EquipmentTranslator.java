...
public class EquipmentTranslator {
  ...
  public EquipmentEntity setEquipmentDtoToEquipmentEntity(
      EquipmentEntity equipmentEntity, EquipmentDto equipmentDto) {
  ...
  public EquipmentDto setEquipmentEntityToEquipmentDto(EquipmentEntity entity) {
    ...
    if (entity.getImage() != null && !entity.getImage().isEmpty()) {
      imageToResponse =
          genericUtilities.readImageFromServer(EQUIPMENT_IMAGE_DIRECTORY, entity.getImage());
    }
